...
class SimpleRLPlayer(SimpleHeuristicsPlayer):
...
async def main():
    ...
    second_opponent = MaxBasePowerPlayer(battle_format="gen1randombattle")
    ...
    players = [
        eval_env.agent,
        RandomPlayer(battle_format="gen1randombattle"),
        MaxBasePowerPlayer(battle_format="gen1randombattle"),
        SimpleHeuristicsPlayer(battle_format="gen1randombattle"),
    ]
